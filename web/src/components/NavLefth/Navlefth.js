...
export default function Navlefth() {
    ...
    <div id="perfil-student-home-page">
      <div id="option-student-home-page">
        <ul>
          ...
          <button id="creat-button" type="button">
          ...
          <Link to="/allstudent">
            <MdFormatAlignLeft className="ic-left" color="#cbcbd6" size={25} />{' '}
            listar Estudante
          </Link>

          <Link to="/deletstudent">
            <MdDelete className="ic-left" color="#cbcbd6" size={25} /> Deletar
            Estudante
          </Link>
        </ul>
      </div>{' '}
